            ...
            <div class="row justify-content-sm-center justify-content-md-start g-30">
                <div class="col-lg-4 col-md-6 col-sm-10">
                    <div class="feature__card">
                        <div class="feature__card--content">
                            <div class="icon">
                                <img src="assets/images/service/www.png" alt="">
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-10">
                    <div class="feature__card">
                        <div class="feature__card--content">
                            <div class="icon">
                                <img src="assets/images/service/domain-finder.png" alt="">
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-10">
                    <div class="feature__card">
                        <div class="feature__card--content">
                            <div class="icon">
                                <img src="assets/images/service/validity-checker.png" alt="">
                            </div>
            ...
            <div class="row">
                <div class="result-content">
                    ...
                    <div class="result-content__right">
                        <figure>
                            <img src="assets/images/service/whois-image.png" srcset="assets/images/service/whois-image2x.png 2x" alt="">
                        </figure>
                    </div>
                </div>
            </div>
