            ...
            <div class="row gy-30">
                    ...
                    <div class="single__feature">
                        <div class="single__feature--box hover-enabled text-center">
                            <div class="single__feature--box-icon without-icon-bg m-auto">
                                <img src="assets/images/icon/support-icon.svg" alt="">
                            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6" data-sal="slide-down" data-sal-delay="700" data-sal-duration="800">
                    <div class="single__feature">
                        <div class="single__feature--box hover-enabled text-center">
                            <div class="single__feature--box-icon without-icon-bg m-auto">
                                <img src="assets/images/icon/backup.svg" alt="">
                            </div>
                            <h5 class="single__feature--box-title">
                                Automated Backups
                            </h5>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6" data-sal="slide-down" data-sal-delay="800" data-sal-duration="800">
                    <div class="single__feature">
                        <div class="single__feature--box hover-enabled text-center">
                            <div class="single__feature--box-icon without-icon-bg m-auto">
                                <img src="assets/images/icon/ssl-setup.svg" alt="">
                            </div>
                            <h5 class="single__feature--box-title">
            ...
            <div class="row align-items-center justify-content-md-center g-30">
                ...
                <div class="col-lg-6">
                    <div class="affiliate-feature-img">
                        <img src="assets/images/feature/ssl-feature.jpg" height="500" width="645" alt="">
                    </div>
                </div>
            </div>
        </div>
