        ...
        try {
            ...
            document.querySelectorAll('.easy-language-switcher-select li').forEach(option => {
                option.addEventListener('click', function () {
                    ...
                    rtCurrencyLanguage.updateUserPreferredLanguage(selected);
...
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', () => rtCurrencyLanguage.init());
} else {
    rtCurrencyLanguage.init();
}