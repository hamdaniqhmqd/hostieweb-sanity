                    ...
                    <div class="banner-area">
                        <div class="rts-hosting-banner rts-hosting-banner__content support__banner">
                            ...
                            <div class="hosting-action mt-5" data-sal="slide-down" data-sal-delay="400" data-sal-duration="800">
                                <img src="assets/images/banner/title-shape-2.svg" alt=""> <a href="#" class="btn__white"> 24/7 Hours Dedicated Support</a>
                            </div>
                        </div>
                        <div class="rts-hosting-banner__image support">
                            <img src="assets/images/banner/support/banner__support__image.svg" alt="">
                            <img class="shape one shake-br" src="assets/images/banner/support/banner__support__image-sm-1.svg" alt="">
                            <img class="shape two shake-tl" src="assets/images/banner/support/banner__support__image-sm-2.svg" alt="">
                            <img class="shape three rotate-one" src="assets/images/banner/support/banner__support__image-sm-3.svg" alt="">
                            <img class="shape four rotate-two" src="assets/images/banner/support/banner__support__image-sm-4.svg" alt="">
                            <img class="shape five" src="assets/images/banner/support/banner__support__image-sm-5.svg" alt="">
                            <img class="shape six rotate-one" src="assets/images/banner/support/banner__support__image-sm-6.svg" alt="">
                            <img class="shape seven" src="assets/images/banner/support/banner__support__image-sm-7.svg" alt="">
                        </div>
                    </div>
                </div>
            </div>
